...
C([ags[i] for i in ("geral","conferencia","conselho")],obs.Theme,u"Tema")
...
C([ags[i] for i in ("geral","conferencia","mesa","forumInterconselhos","audiencia","consulta")],obs.Participant,u"Participante")
