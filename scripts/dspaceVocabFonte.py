...
for arquivo in arquivos:
    ...
    for palavra in termos_:
        ...
        palavra_=" ".join(w.capitalize() if w not in ["de","e","da","do","na","no",u"à"] else w for w in palavra[:-1].split())
        termo.set("label",palavra_.decode("utf-8"))
tree = ET.ElementTree(root)
tree.write('../vocabulario/dspaceMec.xml', xml_declaration=True, encoding='utf-8')
